...
QT_MOC_LITERAL(1, 12, 11), // "cellClicked"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 1), // "x"
QT_MOC_LITERAL(4, 27, 1) // "y"

    },
    "CustomScene\0cellClicked\0\0x\0y"
};
...
void CustomScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (CustomScene::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CustomScene::cellClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CustomScene::cellClicked(int _t1, int _t2)
{
